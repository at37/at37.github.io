var TopTen={
    display: async function() {
        ...
        .attr("x", 350) // Adjust the x position to center the rectangle
        ...
        const text = svg.append("text")
                ...
                .text("Top 10 Countries - Medals Won")
                .attr("font-size", "30px")
                .attr("fill", "blue")
        ...
        function dv_onMouseOver() {
            ...
            "<span style = 'font-size:12px;font-family:Arial;font-weight: bold;color:#EE4E34'><b> Gold Medals: </b>" + gMedals[d.toString().split(",")[0]] + "</span></br>" +
            "<span style = 'font-size:12px;font-family:Arial;font-weight: bold;color:#4831D4'><b> Silver Medals: </b>" + sMedals[d.toString().split(",")[0]] + "</span></br>" +
            "<span style = 'font-size:12px;font-family:Arial;font-weight: bold;color:#990011'><b> Bronze Medals: </b>" + bMedals[d.toString().split(",")[0]] + "</span>";
